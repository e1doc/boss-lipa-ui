<template>
  <section class="meta-navigation flex-center">
    <div class="meta-left-box flex-center">
      <img class="meta-img" src="../../assets/lipa-logo.png" />
      <div class="meta-site-name">Lipa One Stop<br />Shop System</div>
    </div>
    <div v-if="isAuthenticated" class="meta-center-box">
      <ul class="meta-nav">
        <li class="meta-menu redirect" @click="extRedirect">Lipa.gov.ph</li>
    ...
    <div v-if="isAuthenticated" class="meta-right-box">
      <ul class="meta-nav flex-center hide-in-mobile">
        ...
        <!--
          <li class="meta-login">
          <a href="login" @click="proceedToRegister" target="_blank"
            ><font-awesome-icon icon="user" class="mr10 user-icon" />LOGIN</a
          >
        </li>
        -->
        <li class="meta-register">
          <a @click="proceedToRegister"
            ><font-awesome-icon icon="user" class="mr10 user-icon" />REGISTER</a
          >
        </li>
        <li class="meta-login">
          <a @click="proceedToLogin"
            ><font-awesome-icon icon="user" class="mr10 user-icon" />LOGIN</a
          >
        </li>
      </ul>
      ...
      <div class="meta-wrap">
        ...
        <div class="profile-menu flex-center">
          ...
          <div class="meta-user-info">
            ...
            <h3>Lipa One Stop Shop System</h3>
          </div>
        </div>
        <ul class="mobile-menu">
          ...
          <li
            ...
            @click="
              slidemenu = false;
              menuActive = 'user_login';
            "
            :class="{ active: menuActive == 'user_login' }"
          >
          ...
          >
            <router-link :to="{ name: 'BusinessPermitApplication' }">
          ...
          >
            <router-link :to="{ name: 'BuildingPermitApplication' }">
          ...
          >
            <router-link :to="{ name: 'BusinessPermitEnrollment' }">
          ...
          >
            <router-link :to="{ name: 'RealPropertyEnrollment' }">
          ...
          >
            <router-link :to="{ name: 'RequestNewTaxDec' }">
              <font-awesome-icon icon="laptop-house" class="mr10 icon" />
          ...
          >
            <router-link :to="{ name: 'StatementOfAccounts' }">
          ...
          >
            <router-link :to="{ name: 'UserInquiries' }">
...
export default {
  ...
  methods: {
    ...
    extRedirect() {
      window.open("http://lipa.gov.ph/", "_blank");
    },
    /*
    proceedToRealProperty() {
      this.$router.push({ name: "Login" });
      this.$store.commit("setAuthType", "register");
    },
    */
    proceedToLogin() {
