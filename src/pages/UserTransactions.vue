<template>
  <section>
    <div class="container">
          ...
          <div class="meta-delivery-details-table">
            <div class="meta-items-holder">
              <div class="meta-items">
                ...
                <div class="flex-grow">Lipa Government Center</div>
              </div>
              <div class="meta-items">
      ...
      <piso-pay-transaction-table v-if="currentTable === 'pisopay'" />
    </div>
  </section>
</template>
...
import PisoPayTransactionTable from "@/components/tables/PisoPayTransactionTable";
export default {
