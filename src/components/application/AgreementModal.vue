<template>
  <div class="meta-modal">
    <div class="meta-wrap">
      <div class="meta-text">
        I hereby authorize the City Government of Lipa, to collect and process
        the data indicated herein for the purpose of {{ type }}. I understand
        that my personal information is protected by RA 10173, Data Privacy Act
        of 2012.
      </div>
