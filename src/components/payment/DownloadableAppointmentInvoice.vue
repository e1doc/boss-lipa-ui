<template>
    ...
    <div class="dialog-holder" ref="content">
      <div class="dialog-header">
        <div class="store-avatar">
          <img src="@/assets/lipa-logo.png" alt="" />
        </div>
        <div class="text-bold size18">Lipa One Stop Shop System</div>
        <div class="triangle">
  ...
  <div class="new-invoice-container">
    <img src="@/assets/lipa-logo.png" alt="" id="logoImage" />
  ...
  methods: {
    ...
    generateAppointmentInvoice() {
      ...
      var header = function(data) {
        ...
        doc.text("Lipa One Stop Shop", 242, 95);
