        ...
        <li>
          <div class="meta-checkbox flex-center">
            ...
            <label for="legal_docs_1"
              >1. Certified true copy of Transfer Certificate of Title (TCT)
            ...
            <li>
              ...
              <ul class="sub-list">
                <li>
                  ...
                  valid ID of applicant and representative) - Notarized
                ...
                <li>
                  ...
                  Notarized <span class="copy-indicator">1 Photocopy</span>
                </li>
              </ul>
            </li>
          </ul>
    ...
    <div class="meta-form-group mb60">
      ...
      <ul class="parent-list">
        <li>
          ...
          <ul class="main-list">
            <li>
              United Application Form for Building Permit and FSEC(signed and
              dry seal by an Engineer/Architect and applicant on all pages) -
              Notarized <span class="copy-indicator">5 Copies</span>
            </li>
            <li>
    ...
    <div class="meta-form-group mb60">
      ...
      <ul class="parent-list">
        <li>
          ...
          <ul class="sub-list">
            <li>
              Project Specification <span class="copy-indicator">2 Copies</span>
            </li>
            <li>
              Bill of Materials <span class="copy-indicator">3 Copies</span>
            </li>
            <li>
              Structural Design Analysis and Computation (for structure two(2)
              storey and above NSCP 5th Edition)
              <span class="copy-indicator">1 Copy</span>
            </li>
            <li>
              Geotech Report/Soil Boring Test Report (for building structures
        ...
        <li>
          <div class="meta-checkbox flex-center">
            ...
            <label for="specs_3"
              >3. PCAB License of Electrical Contractor for Electrical Works
