<template>
  <div class="meta-list">
    ...
    <div
      class="meta-list-option"
      v-if="currentPaymentType === 'pisopay' && isFeatureImplemented"
    >
      <div class="meta-radio flex-center">
        <input
          type="radio"
        ...
        <span
          class="custom-radio flex-center"
          :class="{
            selected: currentPaymentType === 'pisopay' ? true : false,
          }"
          ><span class="circle"></span
        ></span>
        <label for="option_2">Pay using Pisopay</label>
      </div>
      <div class="meta-desc">
        You can now pay your bills through online with Pisopay without any
        hassle.
        <br />
        <div class="text-underline meta-view-more" @click="showImg(0)">
          View more instruction
