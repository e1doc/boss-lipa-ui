<template>
  ...
  >
    ...
    <input
      type="hidden"
      name="ReturnURLOK"
      value="https://bossapi.lipa.gov.ph/api/payment-success/"
    />

    <input
      type="hidden"
      name="ReturnURLError"
      value="https://bossapi.lipa.gov.ph/api/payment-error/"
    />
...
export default {
  ...
  methods: {
    ...
    async submit() {
      ...
      formData.append(
        "ReturnURLOK",
        "https://bossapi.lipa.gov.ph/api/payment-success/"
      );
      formData.append(
        "ReturnURLError",
        "https://bossapi.lipa.gov.ph/api/payment-error/"
      );
